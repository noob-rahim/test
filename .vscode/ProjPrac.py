...
#     tk.Button(add_window, text="Add University", command=save_university).grid(row=4, columnspan=2)
...
def search_universities():
    ...
    tk.Label(search_window, text="PTE Score", bg="#F0F0F0").grid(row=4, column=0)
    ...
    tk.Button(search_window, text="Submit", command=suggest_universities, bg="#007ACC", fg="white").grid(row=5, columnspan=2)
...
def add_university():
    ...
    tk.Label(add_window, text="PTE Score", bg="#F0F0F0").grid(row=5, column=0)
    ...
    tk.Button(add_window, text="Add University", command=save_university, bg="#007ACC", fg="white").grid(row=6, columnspan=2)
